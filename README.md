...
**버전 2.1 - 새로운 Mixed View 기능 추가!** 이제 Gemini와 ChatGPT를 한 화면에서 동시에 사용할 수 있습니다.
...
2. **Layout Grid**에서 원하는 행/열 설정 (예: 2x2) - 변경 시 자동 저장
3. 각 프레임 상단 드롭다운에서 Gemini Gem 또는 ChatGPT GPT 선택
4. Gemini와 ChatGPT를 자유롭게 조합하여 사용

**팁**: Mixed View는 항상 빈 프레임으로 시작하여, 원하는 AI를 직접 선택할 수 있습니다.
...
### 실시간 동기화
- 레이아웃 변경 시 즉시 저장 (Mixed View는 자동 적용)
- Gem/GPT 추가/삭제 시 자동 저장
- 서비스별 첫 번째 프레임은 기본 URL로 자동 로드
...
- 레이아웃 변경(행/열)은 즉시 저장되며 서비스별로 관리됩니다
  - Mixed View는 레이아웃 변경 시 자동 적용됩니다
- Gem/GPT 목록은 드래그로 순서 변경이 가능합니다
- 다른 서비스 페이지에서 확장 프로그램을 열면 Gemini, ChatGPT, 또는 Mixed View로 이동할 수 있는 버튼이 표시됩니다
...
- Dynamic iframe layout management
